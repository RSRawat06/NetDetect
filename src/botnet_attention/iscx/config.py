...
PARSE_FEATURE = [["ip.len", "frame.time_epoch", "tcp.len", "udp.len"], ["eth.dst", "tcp.dstport", "tcp.srcport", "udp.dstport", "udp.srcport", "ip.proto", "ip.flags", "frame.protocols", "tcp.flags"], ["ip.src", "ip.dst"], "FlowNo"]
STORE_CATEGORICALS = [["eth.dst", "tcp.dstport", "tcp.srcport", "udp.dstport", "udp.srcport", "ip.proto", "ip.flags", "frame.protocols", "tcp.flags"]]
