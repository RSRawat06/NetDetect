...
numerical_fields = ["ip.len", "frame.time_epoch", "tcp.len", "udp.len"]
protocol_fields = ["frame.protocols"]
categorical_fields = ["ip.proto", "ip.flags", "tcp.flags"]
port_fields = ["tcp.dstport", "tcp.srcport", "udp.dstport", "udp.srcport"]
flow_field = "FlowNo"
participant_fields = ["ip.src", "ip.dst"]
