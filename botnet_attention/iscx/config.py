...
COLUMNS = {'numerical': ["ip.len", "frame.time_epoch", "tcp.len", "udp.len"], 'participant': ["ip.src", "ip.dst"], 'flow_field': "FlowNo"}
CATEGORICAL_COLUMNS = ["eth.dst", "tcp.dstport", "tcp.srcport", "udp.dstport", "udp.srcport", "ip.proto", "ip.flags", "tcp.flags"]
PROTOCOL_COLUMNS = ["frame.protocols"]
