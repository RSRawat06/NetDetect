...
Temp configuration file for unit tests.
"""
...
N_PACKET_GRU_HIDDEN = 7
N_PACKET_DENSE_HIDDEN = 11
N_PACKET_ATTENTION_HIDDEN = 13
N_FLOW_GRU_HIDDEN = 17
N_FLOW_DENSE_HIDDEN = 19
N_FLOW_ATTENTION_HIDDEN = 23
